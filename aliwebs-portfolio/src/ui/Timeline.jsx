...
function AboutTimeline() {
  ...
  <div className="about-text">
    <p>
      ...
      beautiful, functional websites powered by AI technologies for startups and
      businesses in Lebanon.
    </p>
    <p>
      With expertise in modern web technologies and AI integration, I bridge the
      gap between innovative design and technical implementation to deliver
  ...
  <div className="timeline">
    <div className="timeline-item">
      ...
      <div className="timeline-content">
        ...
        <p>
          Incorporating AI tools to streamline development and create smarter,
    ...
    <div className="timeline-item">
      ...
      <div className="timeline-content">
        ...
        <p>
          ...
          JavaScript, laying the foundation for my AI web development services.
        </p>
      </div>
    </div>
    <div className="timeline-item">
      ...
      <div className="timeline-content">
        ...
        <p>
          Fell in love with programming after taking an online web development
          course, sparking my journey into AI-powered website creation.
        </p>
      </div>
    </div>
  </div>
